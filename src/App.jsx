...
const App = () => {
    ...
    const handleAdminLogout = async () => {
        ...
        try {
            ...
            alertUser('Ошибка', 'Не удалось выйти из системы.');
        }
    };
    ...
    const alertUser = (title, message) => {
        ...
        if (typeof window !== 'undefined') {
            ...
            tempDiv.innerHTML = `
                <div style="position:fixed; top:50%; left:50%; transform:translate(-50%, -50%); background:white; padding:20px; border-radius:10px; box-shadow:0 4px 6px rgba(0,0,0,0.2); z-index:1000; max-width: 90vw; text-align: center; border: 2px solid ${title.includes('Ошибка') ? '#ef4444' : '#10b981'};">
    ...
    const AdminLoginModal = () => {
        ...
        return (
            <Modal isOpen={isLoginModalOpen} onClose={() => setIsLoginModalOpen(false)} title="Вход Администратора (Firebase Auth)">
                <p className="text-sm text-gray-600 mb-4">
                    Для администрирования используйте Email и Пароль, зарегистрированные в консоли Firebase.
                </p>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-end mt-4 space-x-3">
                        <button type="button" onClick={() => setIsLoginModalOpen(false)} className="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition">
                            Отмена
                        </button>
    ...
    const AddAlbumModal = () => {
        ...
        return (
            <Modal isOpen={isAddAlbumModalOpen} onClose={() => setIsAddAlbumModalOpen(false)} title="Создать новый альбом">
                <form onSubmit={handleSubmit}>
                    <input
                        type="text"
                        value={albumName}
    ...
    const AddDividerModal = () => {
        ...
        return (
            <Modal isOpen={isAddDividerModalOpen} onClose={() => setIsAddDividerModalOpen(false)} title="Добавить текстовый разделитель">
                <form onSubmit={handleSubmit}>
                    ...
                    <input
                        ...
                        placeholder="Например: Глава 5: Неожиданная встреча"
                        className="w-full p-3 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                        required
                    />
                    <div className="flex justify-end mt-4 space-x-3">
